...
const PACKAGE_NAME: &str = "@browsermcp/mcp";
const MCP_SERVER_PATH: &str = "node_modules/@browsermcp/mcp/dist/index.js";

struct BrowserMcpExtension;

impl zed::Extension for BrowserMcpExtension {
    fn new() -> Self {
        Self
    }
...
zed::register_extension!(BrowserMcpExtension);
